...
from app.models import Store, User, Role, Register, RegisterSession, CashDrawerEvent, Sale
...
class RegisterSystemTest(unittest.TestCase):
    ...
    def test_register_creation(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_register_creation: Register created successfully")
    ...
    def test_unique_register_number_per_store(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_unique_register_number_per_store: Duplicate prevention works")
    ...
    def test_open_shift(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_open_shift: Shift opened and logged correctly")
    ...
    def test_prevent_multiple_open_shifts(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_prevent_multiple_open_shifts: Multiple shifts prevented")
    ...
    def test_close_shift_with_variance(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_close_shift_with_variance: Shift closed, variance calculated")
    ...
    def test_close_shift_balanced(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_close_shift_balanced: Balanced shift works correctly")
    ...
    def test_cannot_reopen_closed_shift(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_cannot_reopen_closed_shift: Session immutability enforced")
    ...
    def test_no_sale_drawer_open(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_no_sale_drawer_open: No-sale event logged correctly")
    ...
    def test_cash_drop(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_cash_drop: Cash drop logged and expected cash adjusted")
    ...
    def test_drawer_event_audit_trail(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_drawer_event_audit_trail: Complete audit trail maintained")
    ...
    def test_multiple_shifts_on_register(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_multiple_shifts_on_register: Sequential shifts work correctly")
    ...
    def test_expected_cash_calculation(self):
        ...
        with self.app.app_context():
            ...
            print("✅ test_expected_cash_calculation: Expected cash calculation correct")
